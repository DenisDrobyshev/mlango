...
class Callback:
    ...
    def on_epoch_end(self, run: Any, epoch: int, metrics: dict[str, float], **kwargs: Any) -> None: ...

    def on_batch_end(self, run: Any, step: int, metrics: dict[str, float], **kwargs: Any) -> None: ...
