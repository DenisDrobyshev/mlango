...
"""Generated by mlango 0.1.0 on 2026-07-30 12:00."""
...
Девять таблиц метастора принадлежат фреймворку и никогда не меняют форму по
...
Не реализовано в 0.1. Пока проект, которому нужен чистый лист, может удалить свои
